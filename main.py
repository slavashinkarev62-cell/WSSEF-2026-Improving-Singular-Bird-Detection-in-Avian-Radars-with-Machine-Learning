...
# For this project we use Open-AI as a final touch
client = OpenAI(api_key="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")

# This is our trained Yolo model
model = YOLO('best.pt') 
...
def generate_radar_report(telemetry_data):
    ...
    try:
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=messages,
            temperature=0.2 # we need to keep it analytical, not creative
        )
